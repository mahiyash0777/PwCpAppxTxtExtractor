...
API_ID = int(os.environ.get("API_ID", 24201237))
API_HASH = os.environ.get("API_HASH", "fc82db3f86816844f36abd55bf218b12")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7718886627:AAFq__5bZYBiD195qM13iIEb2nCC-q7v3C0")
